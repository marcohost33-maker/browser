...
- Run timestamp (wall clock, informational only): 2026-08-14T10:31:45.779Z
...
| Cold start (spawn→#status settled) | 152 ms (state=done) |
| Warm start (2nd load, same session) | 149 ms (state=done) |
| Warm-run probes read + compared | 12 reported, 0 deviation(s), 0 missing |
| Idle resident memory (sum workingSetSize) | 272.7 MiB (279196 KB) |
...
- Browser: 92.6 MiB (94788 KB)
- GPU: 58.6 MiB (60040 KB)
- Utility: 41.2 MiB (42176 KB)
- Tab: 80.3 MiB (82192 KB)
